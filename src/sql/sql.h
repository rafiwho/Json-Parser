...
#ifndef YY_SQL_SRC_SQL_SQL_H_INCLUDED
# define YY_SQL_SRC_SQL_SQL_H_INCLUDED
/* Debug traces.  */
#ifndef SQL_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
union SQL_STYPE
{
#line 23 "src/sql/sql.y"

    char* string;
    int number;

#line 138 "src/sql/sql.h"
...
#endif /* !YY_SQL_SRC_SQL_SQL_H_INCLUDED  */
